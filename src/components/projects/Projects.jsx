  ...
  return (
    <div>
        <div className="grid grid-cols-2 px-1 py-8">
            ...
            <div className="">
                <h3 className="capitalize text-2xl mb-3 dark:text-[#CCD6F6] font-semibold"><span className="text-[#0A192F] font-bold dark:text-[#5AE5C6] text-base ">4.</span> Projects</h3>
                <div className=''>
                {
